...
afterwards. I will start by creating basic CRUD operations for a single users table, then I'll work on protecting the routes used in those <br> 
operations and keep with that pattern for each of the other objectives. Once I'm through with the first iteration I will go back to do improvements. </p>
